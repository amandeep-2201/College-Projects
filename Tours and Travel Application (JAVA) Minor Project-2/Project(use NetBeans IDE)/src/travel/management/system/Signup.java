...
public class Signup extends JFrame implements ActionListener{
	...
	contentPane.add(lblSecurityQuestion);
        JLabel lblSecurityQuestion1 = new JLabel("What's your nickname ? ");
	lblSecurityQuestion1.setForeground(Color.DARK_GRAY);
	lblSecurityQuestion1.setFont(new Font("Tahoma", Font.BOLD, 14));
	lblSecurityQuestion1.setBounds(260, 197, 200, 26);
	contentPane.add(lblSecurityQuestion1);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            Conn con = new Conn();
            if(ae.getSource() == b1){
                String sql = "insert into account(username, name, password, answer) values(?, ?, ?, ?)";
